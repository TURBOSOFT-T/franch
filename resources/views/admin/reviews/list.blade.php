                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('reviews') }}">Les avis</a>
                                </li>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="hover-flip-item">
                                                <span data-text="Cameron Williamson">{{ $review->user->prenom }}
                                           ...
                                           {{--  <a href="{{ route('reviews.edit', $review->id) }}"
                                            ...
                                            @if ($review->active)
                                                <button class="btn btn-warning btn-sm"
                                                    onclick="confirmAction('{{ route('reviews.disapprove', $review->id) }}', 'Disapprove', 'Really disapprove this review?')">
                                                    <i class="fas fa-times"></i> Disapprove
                                                </button>
                                            @else
                                                <button class="btn btn-success btn-sm"
                                                    onclick="confirmAction('{{ route('reviews.approve', $review->id) }}', 'Approve', 'Really approve this review?')">
