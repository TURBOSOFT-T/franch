...
Route::get('/details-formation/{id}/{slug}', [FormationController::class, 'details'])->name('details-formation');
...
Route::post('/cart/clear', [panier_client::class, 'clear'])->name('cart.clear');
...
/////////////////Reviews///////////
    Route::get('/admin/reviews', [AdminController::class,'reviews'])
        ->name('reviews');
    Route::get('/admin/review/{id}/delete', [AdminController::class,'review_delete']);
    Route::resource('reviews', ReviewController::class);
    Route::get('reviews/{id}/disapprove', [ReviewController::class, 'disapprove'])->name('reviews.disapprove');
